...
from .dataset_readers import readEndoNeRFInfo  # Absolute import
...
class Scene:
    ...
    def __init__(self, args : ModelParams, gaussians : GaussianModel, load_iteration=None, shuffle=True, resolution_scales=[1.0], load_coarse=False, batch=0):
        """b
        ...
        if os.path.exists(os.path.join(args.source_path, "sparse")):
            ...
            scene_info = sceneLoadTypeCallbacks["endonerf"](args.source_path, args.white_background, args.eval, args.use_pretrain,  batch=batch)
