...
#     parser.add_argument("--dataset_root", type=str, default='data/endonerf/Patient_136_Run_2_paper')
...
if __name__ == "__main__":
    parser = ArgumentParser()
    parser.add_argument("--dataset_root", type=str, required=True, help="Path to the root dataset directory")
    parser.add_argument("--rgb_paths", type=str, default='images') # required=True, help="Path to the RGB images folder relative to the dataset root")
    args = parser.parse_args()
    main(args)
